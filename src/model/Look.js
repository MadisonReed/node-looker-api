(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './LookModel', './SpaceBase', './UserIdOnly'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LookModel'), require('./SpaceBase'), require('./UserIdOnly'));
  } else {
    // Browser globals (root is window)
    if (!root.LookerApi30Reference) {
      root.LookerApi30Reference = {};
    }
    root.LookerApi30Reference.Look = factory(root.LookerApi30Reference.ApiClient, root.LookerApi30Reference.LookModel, root.LookerApi30Reference.SpaceBase, root.LookerApi30Reference.UserIdOnly);
  }
}(this, function(ApiClient, LookModel, SpaceBase, UserIdOnly) {
  'use strict';

  /**
   * The Look model module.
   * @module model/Look
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>Look</code>.
   * @alias module:model/Look
   * @class
   */
  ...
  /**
   * Constructs a <code>Look</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Look} obj Optional instance to populate.
   * @return {module:model/Look} The populated <code>Look</code> instance.
   */
